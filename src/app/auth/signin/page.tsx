      ...
      <div className="space-y-4">
        ...
        <div>
          <Link
            ...
            className="w-full flex justify-center py-2.5 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
          >
            아이디/비밀번호로 로그인
          </Link>
        </div>
        ...
        <div>
          <Link
            href="/auth/register"
            className="w-full flex justify-center py-2.5 px-4 border border-indigo-500 rounded-md shadow-sm bg-indigo-50 text-sm font-medium text-indigo-700 hover:bg-indigo-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
          >
            회원가입
          </Link>
        </div>
